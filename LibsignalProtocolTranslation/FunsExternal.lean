...
@[rust_fun
  "libsignal_core::address::{libsignal_core::address::ServiceId}::service_id_fixed_width_binary"]
axiom libsignal_core.address.ServiceId.service_id_fixed_width_binary
  : libsignal_core.address.ServiceId → Result (Array Std.U8 17#usize)
...
@[rust_fun
  "libsignal_core::address::{libsignal_core::address::ProtocolAddress}::name"]
axiom libsignal_core.address.ProtocolAddress.name
  : libsignal_core.address.ProtocolAddress → Result Str
...
@[rust_fun
  "libsignal_core::address::{libsignal_core::address::ProtocolAddress}::device_id"]
axiom libsignal_core.address.ProtocolAddress.device_id
  :
  libsignal_core.address.ProtocolAddress → Result
...
@[rust_fun
  "libsignal_core::curve::{libsignal_core::curve::PublicKey}::public_key_bytes"]
axiom libsignal_core.curve.PublicKey.public_key_bytes
  : libsignal_core.curve.PublicKey → Result (Slice Std.U8)
...
@[rust_fun
  "libsignal_core::curve::{libsignal_core::curve::PublicKey}::serialize"]
axiom libsignal_core.curve.PublicKey.serialize
  : libsignal_core.curve.PublicKey → Result (Slice Std.U8)
...
@[rust_fun
  "libsignal_core::curve::{libsignal_core::curve::PublicKey}::is_canonical"]
axiom libsignal_core.curve.PublicKey.is_canonical
...
@[rust_fun
  "libsignal_core::curve::{libsignal_core::curve::PrivateKey}::serialize"]
axiom libsignal_core.curve.PrivateKey.serialize
  : libsignal_core.curve.PrivateKey → Result (alloc.vec.Vec Std.U8)
...
@[rust_fun
  "libsignal_core::curve::{libsignal_core::curve::KeyPair}::from_public_and_private"]
axiom libsignal_core.curve.KeyPair.from_public_and_private
  :
  Slice Std.U8 → Slice Std.U8 → Result (core.result.Result
    libsignal_core.curve.KeyPair libsignal_core.curve.CurveError)
