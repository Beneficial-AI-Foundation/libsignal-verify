...
axiom libsignal_core.address.SpecificServiceId (RAW_KIND : Std.U8) : Type
...
axiom libsignal_core.address.DeviceId : Type
...
axiom libsignal_core.address.ProtocolAddress : Type
...
axiom libsignal_core.curve.PublicKey : Type
...
axiom libsignal_core.curve.PrivateKey : Type
